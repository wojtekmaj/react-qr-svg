[![npm](https://img.shields.io/npm/v/@wojtekmaj/react-qr-svg.svg)](https://www.npmjs.com/package/@wojtekmaj/react-qr-svg) ![downloads](https://img.shields.io/npm/dt/@wojtekmaj/react-qr-svg.svg) [![CI](https://github.com/wojtekmaj/react-qr-svg/actions/workflows/ci.yml/badge.svg)](https://github.com/wojtekmaj/react-qr-svg/actions)
...
- Use by adding `<QrSvg margin={4} value="Hello world" />`.
...
function MyApp() {
  return (
    <div>
      <QrSvg margin={4} value="Hello world" />
    </div>
  );
}
```
